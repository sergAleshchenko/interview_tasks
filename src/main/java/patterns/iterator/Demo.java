...
import patterns.iterator.social_networks.Facebook;
import patterns.iterator.social_networks.LinkedIn;
import patterns.iterator.social_networks.SocialNetwork;
import patterns.iterator.spammer.SocialSpammer;
...
public class Demo {
    ...
    public static void main(String[] args) {
        System.out.println("Please specify social network to " +
                "target spam tool (default:Facebook):");
