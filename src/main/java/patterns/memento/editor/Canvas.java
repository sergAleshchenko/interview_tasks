package patterns.memento.editor;

import patterns.memento.commands.ColorCommand;
import patterns.memento.commands.MoveCommand;
import patterns.memento.shapes.Shape;
...
public class Canvas extends java.awt.Canvas {
    ...
    private void createFrame() {
        ...
        contentPanel.add(new JLabel("Select and drag to move."),
                BorderLayout.PAGE_END);
        contentPanel.add(new JLabel("Right click to change color."),
                BorderLayout.PAGE_END);
        contentPanel.add(new JLabel("Undo: Ctrl+Z, Redo: Ctrl+R"),
                BorderLayout.PAGE_END);
...
//                    }
    ...
    private void attachMouseListeners() {
        MouseAdapter colorizer = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                if (target != null) {
                    editor.execute(new ColorCommand(editor,
        ...
        MouseAdapter selector = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                Shape target = editor.getShapes().getChildAt(e.getX(), e.getY());
                boolean ctrl = (e.getModifiersEx() * ActionEvent.CTRL_MASK)
    ...
    public int getWidth() {
        return editor.getShapes().getX() +
                editor.getShapes().getWidth() + PADDING;
    }

    public int getHeight() {
        return editor.getShapes().getY() +
                editor.getShapes().getHeight() + PADDING;
    }
