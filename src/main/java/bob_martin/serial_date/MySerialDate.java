 ...
 * Contributor(s):   -;
 *
 * $Id: MySerialDate.java,v 1.8 2006/08/29 13:44:16 mungady Exp $
 *
 ...
 *  time-zone, or anything else.  That's what we've defined MySerialDate for.
 *  <P>
 *  You can call getInstance() to get a concrete subclass of MySerialDate,
...
//    }
    ...
    public static int monthCodeToQuarter(final int code) {
        ...
        switch(code) {
            ...
            default: throw new IllegalArgumentException(
                    "MySerialDate.monthCodeToQuarter: invalid month code.");
        }
    ...
    public static String monthCodeToString(final int month,
        ...
        if (!isValidMonthCode(month)) {
            throw new IllegalArgumentException(
                    "MySerialDate.monthCodeToString: month outside valid range.");
        }
    ...
    public static String weekInMonthToString(final int count) {
        ...
        switch (count) {
            case MySerialDate.FIRST_WEEK_IN_MONTH : return "First";
            case MySerialDate.SECOND_WEEK_IN_MONTH : return "Second";
            case MySerialDate.THIRD_WEEK_IN_MONTH : return "Third";
     ...
     * @param yyyy  the year (in the range 1900 to 9999).
     *
     * @return An instance of {@link MySerialDate}.
     */
...
//        return null;
     ...
     *
     * @return a instance of MySerialDate.
     */
...
//        return null;
    ...
    /**
     * Factory method that returns an instance of a subclass of MySerialDate.
     *
     ...
     * MySerialDate, we need to define a convention for the 'time of day'.
     *
    ...
    public String toString() {
        return getDayOfMonth() + "-" + MySerialDate.monthCodeToString(getMonth())
                + "-" + getYYYY();
    }
     ...
     */
    public abstract int compare(MySerialDate other);

    /**
     * Returns true if this MySerialDate represents the same date as the
     * specified MySerialDate.
     *
     * @param other  the date being compared to.
     *
     * @return <code>true</code> if this MySerialDate represents the same date as
     *         the specified MySerialDate.
     */
    public abstract boolean isOn(MySerialDate other);

    /**
     * Returns true if this MySerialDate represents an earlier date compared to
     * the specified MySerialDate.
     *
     * @param other  The date being compared to.
     *
     * @return <code>true</code> if this MySerialDate represents an earlier date
     *         compared to the specified MySerialDate.
     */
    public abstract boolean isBefore(MySerialDate other);
     ...
     * @param other  the date being compared to.
     *
     * @return <code>true<code> if this MySerialDate represents the same date
     *         as the specified MySerialDate.
     */
    public abstract boolean isOnOrBefore(MySerialDate other);
     ...
     *         as the specified MySerialDate.
     */
    public abstract boolean isAfter(MySerialDate other);
     ...
     *         as the specified MySerialDate.
     */
    public abstract boolean isOnOrAfter(MySerialDate other);

    /**
     * Returns <code>true</code> if this {@link MySerialDate} is within the
     ...
     * @return A boolean.
     */
    public abstract boolean isInRange(MySerialDate d1, MySerialDate d2);
