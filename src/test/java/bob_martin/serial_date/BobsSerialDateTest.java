...
import java.util.*;
import static bob_martin.serial_date.MySerialDate.*;
...
public class BobsSerialDateTest extends TestCase {
    ...
    public void testGetNearestDayOfWeek() throws Exception {
        assertEquals(d(16, APRIL, 2006), MySerialDate.getNearestDayOfWeek(SUNDAY, d(16, APRIL, 2006)));
        assertEquals(d(16, APRIL, 2006), MySerialDate.getNearestDayOfWeek(SUNDAY, d(17, APRIL, 2006)));
        assertEquals(d(16, APRIL, 2006), MySerialDate.getNearestDayOfWeek(SUNDAY, d(18, APRIL, 2006)));
        assertEquals(d(16, APRIL, 2006), MySerialDate.getNearestDayOfWeek(SUNDAY, d(19, APRIL, 2006)));
        assertEquals(d(23, APRIL, 2006), MySerialDate.getNearestDayOfWeek(SUNDAY, d(20, APRIL, 2006)));
        assertEquals(d(23, APRIL, 2006), MySerialDate.getNearestDayOfWeek(SUNDAY, d(21, APRIL, 2006)));
        assertEquals(d(23, APRIL, 2006), MySerialDate.getNearestDayOfWeek(SUNDAY, d(22, APRIL, 2006)));

        //todo    assertEquals(d(17, APRIL, 2006), getNearestDayOfWeek(MONDAY, d(16, APRIL, 2006)));
        assertEquals(d(17, APRIL, 2006), MySerialDate.getNearestDayOfWeek(MONDAY, d(17, APRIL, 2006)));
        assertEquals(d(17, APRIL, 2006), MySerialDate.getNearestDayOfWeek(MONDAY, d(18, APRIL, 2006)));
        assertEquals(d(17, APRIL, 2006), MySerialDate.getNearestDayOfWeek(MONDAY, d(19, APRIL, 2006)));
        assertEquals(d(17, APRIL, 2006), MySerialDate.getNearestDayOfWeek(MONDAY, d(20, APRIL, 2006)));
...
//        assertEquals(d(18, APRIL, 2006), MySerialDate.getNearestDayOfWeek(TUESDAY, d(17, APRIL, 2006)));
        ...
        assertEquals(d(18, APRIL, 2006), MySerialDate.getNearestDayOfWeek(TUESDAY, d(21, APRIL, 2006)));
        assertEquals(d(25, APRIL, 2006), MySerialDate.getNearestDayOfWeek(TUESDAY, d(22, APRIL, 2006)));
        ...
        assertEquals(d(19, APRIL, 2006), MySerialDate.getNearestDayOfWeek(WEDNESDAY, d(19, APRIL, 2006)));
        assertEquals(d(19, APRIL, 2006), MySerialDate.getNearestDayOfWeek(WEDNESDAY, d(20, APRIL, 2006)));
        assertEquals(d(19, APRIL, 2006), MySerialDate.getNearestDayOfWeek(WEDNESDAY, d(21, APRIL, 2006)));
        assertEquals(d(19, APRIL, 2006), MySerialDate.getNearestDayOfWeek(WEDNESDAY, d(22, APRIL, 2006)));
        ...
        assertEquals(d(20, APRIL, 2006), MySerialDate.getNearestDayOfWeek(THURSDAY, d(20, APRIL, 2006)));
        assertEquals(d(20, APRIL, 2006), MySerialDate.getNearestDayOfWeek(THURSDAY, d(21, APRIL, 2006)));
        assertEquals(d(20, APRIL, 2006), MySerialDate.getNearestDayOfWeek(THURSDAY, d(22, APRIL, 2006)));
        ...
        assertEquals(d(21, APRIL, 2006), MySerialDate.getNearestDayOfWeek(FRIDAY, d(21, APRIL, 2006)));
        assertEquals(d(21, APRIL, 2006), MySerialDate.getNearestDayOfWeek(FRIDAY, d(22, APRIL, 2006)));
        ...
        assertEquals(d(22, APRIL, 2006), MySerialDate.getNearestDayOfWeek(SATURDAY, d(22, APRIL, 2006)));
